...
if(!isset($_SESSION['ClaveMaestro']))
{
        header("Location:index.php");
                        ...
                        $siguiente="select * from tablaactividades order by ClaveActividad desc limit 0,1";
                        $rsiguiente=$conexion->query($siguiente);
                        $r=mysqli_fetch_array($rsiguiente);
                        
                        
                        $ClaveActividad=$r['ClaveActividad'];
              ...
              <div  class="row">
                        <div class="col-sm-offset-0 col-sm-12">
                          <div class="panel panel-primary"  ><!--success, primary o default-->
                              <div class="panel-heading" >  <!--style="background: rgb(0,0,0);"-->
                                        <h3 class="panel-title">Registrar Alumnos
                                        </h3>
                              </div>
                                ...
                                <div class="panel-body">
                                        <form action="" class="form-horizontal" method="post" >
                                                <div class="col-sm-offset-0 col-sm-3">
                                                        <label class="sr-only">
                                                            Clave Actividad: <?php echo $r['ClaveActividad']; ?>
                                                        </label>
                                                ...
                                                <input type="hidden" id="ClaveActividad" name="ClaveActividad" class="form-control" value="<?php echo $r['ClaveActividad']; ?>" placeholder="">
                ...
                <div class="row">
                                ...
                                <div class="col-sm-offset-3 col-sm-3">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="button" class="btn  btn-primary " id="AgregaAlumnoActividadN"><i class="fa fa-user"></i>
                                            Agregar Alumno
                                        </button>
                        ...
                        <thead>
                         ...
                         <tbody>
                                ...
                                <tr>
                                   ...
                                   <td style="text-align: center;"><a onclick="QuitarAlumnosActividadN('<?php echo $row['NoControl']?>');"><span class="glyphicon glyphicon-trash"></span></a></td> <!--a href="QuitarAlumnoTutoria.php?NoControl=<php echo $row['NoControl'];?>"-->
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
