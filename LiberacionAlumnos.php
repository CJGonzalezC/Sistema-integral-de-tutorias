...
$siguiente="select * from tablaliberaciones order by ClaveLibera desc limit 0,1";
$rsiguiente=$conexion->query($siguiente);
$r=mysqli_fetch_array($rsiguiente);


$ClaveLiberacion=$r['ClaveLibera'];
...
//$query1="select * from Alumnos inner join carreras where Alumnos.ClaveCarrera=carreras.ClaveCarrera and NoControl in (select NoControl from subtablaliberaciones  where ClaveLibera='$ClaveLiberacion')";
              ...
              <div  class="row">
                        <div class="col-sm-offset-0 col-sm-12">
                          <div class="panel panel-primary"  ><!--success, primary o default-->
                              <div class="panel-heading" >  <!--style="background: rgb(0,0,0);"-->
                                        <h3 class="panel-title">Liberar Alumnos
                                        </h3>
                              </div>
                                ...
                                <div class="panel-body">
                                        <form action="" class="form-horizontal" method="post" >
                                                ...
                                                <input type="hidden" id="ClaveLibera" name="ClaveLibera" class="form-control" value="<?php echo $r['ClaveLibera']; ?>" placeholder="">
                ...
                <div class="row">
                                ...
                                <div class="col-sm-offset-3 col-sm-3">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="button" class="btn  btn-primary " id="AgregaAlumnoLiberacionN"><i class="fa fa-user"></i>
                                            Agregar Alumno
                                        </button>
                        ...
                        <thead>
                         ...
                         <tbody>
                                ...
                                <tr>
                                   ...
                                   <td style="text-align: center;"><a onclick="QuitarAlumnosLiberacionN('<?php echo $row['NoControl']?>');"><span class="glyphicon glyphicon-trash"></span></a></td> <!--a href="QuitarAlumnoTutoria.php?NoControl=<php echo $row['NoControl'];?>"-->
                                </tr>
                                <?php } ?>
                        </tbody>
                    </table>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                <label>&nbsp&nbsp No se pudo agregar, verifique sus datos sean correctos.</label>
                        </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                                <label>&nbsp&nbsp Agregado Correctamente.</label>
                        </div>
