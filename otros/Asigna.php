              ...
              <div  class="row">
                          ...
                          <div class="panel panel-primary"  ><!--success, primary o default-->
                            ...
                            <div class="col-sm-12">
                                <a class="btn btn-primary" href="ImprimirLista.php?clave=1" target="_blank">Imprimir Lista</a>
                                    ...
                                    <div id="MostrarBoton" class="col-sm-offset-4 col-sm-4">
                                    ...
                                    <!--div id="recargado">
                                        <p><a  class="btn btn-primary" onclick="eliminar('10');" >Recargar</a></p>
                                    </div>
                ...
                <div class="row">
                                <div class="col-sm-offset-3 col-sm-3">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="button" class="btn  btn-primary " id="AgregaAlumno"><i class="fa fa-car"></i>
                                            Agregar
                                        </button>
