...
if(isset($_POST['pasa']) && $_POST['pasa']=='123')
{
       ...
       $ClaveMaestro=$_SESSION['ClaveMaestro'];
       $query="select * from personal where ClaveMaestro='$ClaveMaestro' and Password='$password'";
       $resultado=$conexion->query($query);
       $r=mysqli_fetch_array($resultado);
       
       if(!empty($r)){
        header('location:CambioNip.php?pasa=1');
       }
                        ...
                        <div class="col-sm-offset-3 col-sm-6">
                          <div class="panel panel-primary"  ><!--success, primary o default-->
                              <div class="panel-heading" >  <!--style="background: rgb(0,0,0);"-->
                                        <h3 class="panel-title">Verificar Password<!--<i class="fa fa-users fa-2x pull-right"></i>-->
                                        </h3>
                              </div>
                              ...
                              <div class="panel-body" >
                                ...
                                <input id="ClaveMaestro" name="ClaveMaestro" type="hidden" value="<?php echo $_SESSION['ClaveMaestro'] ?>">  
                                   <input id="pasa" name="pasa" type="hidden" value="123">
